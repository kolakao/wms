    ...
    switch ($rank_type) {
        ...
        case 'guilds':
            ...
            if (cron_check($jq_cron->fields[0]) == false) {
                ...
                $qry_g      = $core_db->Execute("Select top ".$get_config->guilds_top. " Guild.G_name,G_Mark,G_Score,G_Master from Guild left join GuildMember ON Guild.G_Name = GuildMember.G_Name group by Guild.G_Name,G_Mark,G_Score,G_Master order by COUNT(Name) desc");
				while (!$qry_g->EOF) {
